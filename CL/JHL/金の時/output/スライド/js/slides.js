...
/* ─────────────────────────────────────
   共通スタイル（インライン）
   stage = 1920×1080px 固定なのでpx直指定
───────────────────────────────────── */

// ─── スライド1: オープニング ───
window.slideFactories[0] = () => `
<div class="slide active" id="s1" style="
  background: #FAF7F2;
  display: flex;
...
">
  ...
  <div style="
    ...
    color:#9A7B2E; text-transform:uppercase;
    margin-bottom:48px;
  ...
  <div style="
    ...
    font-size:240px; font-weight:500;
  ...
  <div style="
    font-family:'Crimson Pro',serif;
    font-size:52px; letter-spacing:0.55em;
    color:#C9A84C;
    margin-top:40px;
    position:relative; z-index:2;
  ">Golden Moments</div>
  ...
  <div style="
    ...
    color:#B8B3A8; letter-spacing:0.3em;
    margin-top:24px;
    position:relative; z-index:2;
  ">金時草ブランド — JHL+</div>
</div>
...
">
  ...
  <div style="
    ...
    font-size:520px; color:rgba(201,168,76,0.06);
    right:-60px; bottom:-80px; line-height:1;
  ...
  <div style="
    font-family:'Zen Old Mincho',serif;
    font-size:128px; font-weight:500;
    color:#2C2C2C; letter-spacing:0.07em;
    line-height:1.4;
    position:relative; z-index:2;
  ">輝きは、<span style="color:#C9A84C;">準備から</span>始まる。</div>
  <!-- 英語 -->
  <div style="
    font-family:'Crimson Pro',serif; font-style:italic;
    font-size:40px; color:#9A7B2E;
    letter-spacing:0.25em;
    margin-top:48px;
    opacity:0.7;
    position:relative; z-index:2;
  ">Brilliance begins with preparation.</div>
</div>
`;

// ─── スライド3: ブランドストーリー ───
window.slideFactories[2] = () => `
<div class="slide" id="s3" style="
  background: #FAF7F2;
  display: grid;
...
">
  ...
  ">
    ...
    <div style="
      ...
      color:#2C2C2C; letter-spacing:0.05em;
      line-height:1.4;
    ">語らずに、<br>ただ、<br>輝かせる。</div>
    <div style="
      font-family:'Crimson Pro',serif; font-style:italic;
      font-size:28px; color:#9A7B2E;
      letter-spacing:0.15em; margin-top:48px;
      opacity:0.65;
    ">Let it shine. Silently.</div>
  </div>
  <!-- 右：ストーリー本文 -->
  <div style="
    display:flex; flex-direction:column;
  ...
  ">
    ...
    <div style="
      ...
      color:#2C2C2C; line-height:2.5;
      letter-spacing:0.08em;
    ">
      加賀の地で4000年の歴史を持つ<span style="color:#9A7B2E;">金時草</span>。<br>
      その自然の恵みを届けることで、<br>
      今この瞬間から先の人生を、<br>
      元気に・輝くように。<br><br>
      金の時とは、あなたの<span style="color:#9A7B2E;">黄金時代</span>。<br>
      それは今日から始まっている。
    </div>
  </div>
</div>
...
">
  ...
  <div style="
    ...
    color:#2C2C2C; letter-spacing:0.06em;
    line-height:1.2;
    position:relative; z-index:2;
  ">加賀野菜<br>「<span style="color:#C9A84C;">金時草</span>」<br>という唯一の素材</div>
  <!-- 本文 -->
  <div style="
    font-family:'Noto Sans JP',sans-serif;
    font-size:26px; font-weight:300;
    color:#5C5956; line-height:2.2;
  ...
  <div style="
    ...
    color:#9A7B2E; margin-top:32px;
    text-transform:uppercase; opacity:0.65;
    position:relative; z-index:2;
  ">Gynura Bicolor · 金沢 · 加賀</div>
</div>
`;

// ─── スライド5: ブランド4原則 ───
window.slideFactories[4] = () => `
<div class="slide" id="s5" style="
  background: #F5F2EC;
  display: flex;
  flex-direction: column;
  justify-content: center;
...
">
  ...
  <div style="margin-bottom:56px;">
    ...
    <span style="
      ...
      color:#B8B3A8; letter-spacing:0.15em;
      margin-left:24px;
    ">ブランド原則</span>
  </div>
  <!-- 4カード -->
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:28px;">
    <div style="background:#fff;border-radius:16px;padding:48px 36px;border:1px solid #E4E0D8;">
      ...
      <div style="font-family:'Zen Old Mincho',serif;font-size:42px;font-weight:600;color:#2C2C2C;letter-spacing:0.05em;margin-bottom:16px;">静謐</div>
    ...
    <div style="background:#fff;border-radius:16px;padding:48px 36px;border:1px solid #E4E0D8;">
      ...
      <div style="font-family:'Zen Old Mincho',serif;font-size:42px;font-weight:600;color:#2C2C2C;letter-spacing:0.05em;margin-bottom:16px;">輝き</div>
    ...
    <div style="background:#fff;border-radius:16px;padding:48px 36px;border:1px solid #E4E0D8;">
      ...
      <div style="font-family:'Zen Old Mincho',serif;font-size:42px;font-weight:600;color:#2C2C2C;letter-spacing:0.05em;margin-bottom:16px;">伝統</div>
    ...
    <div style="background:#fff;border-radius:16px;padding:48px 36px;border:1px solid #E4E0D8;">
      ...
      <div style="font-family:'Zen Old Mincho',serif;font-size:42px;font-weight:600;color:#2C2C2C;letter-spacing:0.05em;margin-bottom:16px;">準備</div>
...
">
  ...
  ">
    ...
    <div style="
      font-family:'Zen Old Mincho',serif;
      font-size:160px; font-weight:500;
      color:#2C2C2C; letter-spacing:0.04em;
      line-height:1;
    ">金の時</div>
    <div style="
      font-family:'Crimson Pro',serif;
      font-size:32px; letter-spacing:0.45em;
      color:#C9A84C; margin-top:24px;
    ">Golden Moments</div>
  </div>
  <!-- 右 -->
  <div style="
  ...
  ">
    ...
    <div style="background:#fff;border-radius:12px;padding:32px 36px;border-left:4px solid #E8D5A3;">
      ...
      <div style="font-family:'Zen Old Mincho',serif;font-size:32px;font-weight:600;color:#2C2C2C;letter-spacing:0.04em;margin-bottom:8px;">金時草から</div>
    ...
    <div style="background:#fff;border-radius:12px;padding:32px 36px;border-left:4px solid #E8D5A3;">
      ...
      <div style="font-family:'Zen Old Mincho',serif;font-size:32px;font-weight:600;color:#2C2C2C;letter-spacing:0.04em;margin-bottom:8px;">金沢・加賀の金</div>
    ...
    <div style="background:#fff;border-radius:12px;padding:32px 36px;border-left:4px solid #E8D5A3;">
      ...
      <div style="font-family:'Zen Old Mincho',serif;font-size:32px;font-weight:600;color:#2C2C2C;letter-spacing:0.04em;margin-bottom:8px;">黄金の時間</div>
...
">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:60px;">
    ...
    <div>
      ...
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:24px;font-weight:300;color:#2C2C2C;line-height:1.8;padding:20px 0;border-bottom:1px solid rgba(0,0,0,0.05);display:flex;align-items:flex-start;gap:20px;"><span style="font-family:'Crimson Pro',serif;font-size:28px;color:#C9A84C;flex-shrink:0;">✦</span>人生・時間・輝きを語る言葉を使う</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:24px;font-weight:300;color:#2C2C2C;line-height:1.8;padding:20px 0;border-bottom:1px solid rgba(0,0,0,0.05);display:flex;align-items:flex-start;gap:20px;"><span style="font-family:'Crimson Pro',serif;font-size:28px;color:#C9A84C;flex-shrink:0;">✦</span>産地「加賀・金沢」を文脈として使う</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:24px;font-weight:300;color:#2C2C2C;line-height:1.8;padding:20px 0;border-bottom:1px solid rgba(0,0,0,0.05);display:flex;align-items:flex-start;gap:20px;"><span style="font-family:'Crimson Pro',serif;font-size:28px;color:#C9A84C;flex-shrink:0;">✦</span>静かで品のある余白を大切にする</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:24px;font-weight:300;color:#2C2C2C;line-height:1.8;padding:20px 0;display:flex;align-items:flex-start;gap:20px;"><span style="font-family:'Crimson Pro',serif;font-size:28px;color:#C9A84C;flex-shrink:0;">✦</span>ゴールド・ベージュ・オフホワイトで統一</div>
    </div>
    <!-- Don'ts -->
    <div>
      ...
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:24px;font-weight:300;color:#2C2C2C;line-height:1.8;padding:20px 0;border-bottom:1px solid rgba(0,0,0,0.05);display:flex;align-items:flex-start;gap:20px;"><span style="font-family:'Crimson Pro',serif;font-size:28px;color:#B8B3A8;flex-shrink:0;">×</span>「効く」「治る」「予防」などの効能訴求</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:24px;font-weight:300;color:#2C2C2C;line-height:1.8;padding:20px 0;border-bottom:1px solid rgba(0,0,0,0.05);display:flex;align-items:flex-start;gap:20px;"><span style="font-family:'Crimson Pro',serif;font-size:28px;color:#B8B3A8;flex-shrink:0;">×</span>「最高品質」「No.1」などの誇大表現</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:24px;font-weight:300;color:#2C2C2C;line-height:1.8;padding:20px 0;border-bottom:1px solid rgba(0,0,0,0.05);display:flex;align-items:flex-start;gap:20px;"><span style="font-family:'Crimson Pro',serif;font-size:28px;color:#B8B3A8;flex-shrink:0;">×</span>緑×白の一般サプリデザインに近づく</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:24px;font-weight:300;color:#2C2C2C;line-height:1.8;padding:20px 0;display:flex;align-items:flex-start;gap:20px;"><span style="font-family:'Crimson Pro',serif;font-size:28px;color:#B8B3A8;flex-shrink:0;">×</span>ポップすぎる・安売り感のある表現</div>
    </div>
  </div>
</div>
`;
...
">
  ...
  <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:32px;">
    <div>
      <div style="background:#C9A84C;border-radius:12px;height:280px;margin-bottom:20px;"></div>
      <div style="font-family:'Crimson Pro',serif;font-size:20px;letter-spacing:0.2em;color:#2C2C2C;margin-bottom:6px;">Gold</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:16px;font-weight:300;color:#5C5956;">#C9A84C</div>
    </div>
    <div>
      <div style="background:#E8D5A3;border-radius:12px;height:280px;margin-bottom:20px;border:1px solid rgba(0,0,0,0.06);"></div>
      <div style="font-family:'Crimson Pro',serif;font-size:20px;letter-spacing:0.2em;color:#2C2C2C;margin-bottom:6px;">Gold Light</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:16px;font-weight:300;color:#5C5956;">#E8D5A3</div>
    </div>
    <div>
      <div style="background:#9A7B2E;border-radius:12px;height:280px;margin-bottom:20px;"></div>
      <div style="font-family:'Crimson Pro',serif;font-size:20px;letter-spacing:0.2em;color:#2C2C2C;margin-bottom:6px;">Gold Dark</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:16px;font-weight:300;color:#5C5956;">#9A7B2E</div>
    </div>
    <div>
      <div style="background:#B8B3A8;border-radius:12px;height:280px;margin-bottom:20px;border:1px solid rgba(0,0,0,0.06);"></div>
      <div style="font-family:'Crimson Pro',serif;font-size:20px;letter-spacing:0.2em;color:#2C2C2C;margin-bottom:6px;">Platinum</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:16px;font-weight:300;color:#5C5956;">#B8B3A8</div>
    </div>
    <div>
      <div style="background:#FAF7F2;border-radius:12px;height:280px;margin-bottom:20px;border:1px solid #E4E0D8;"></div>
      <div style="font-family:'Crimson Pro',serif;font-size:20px;letter-spacing:0.2em;color:#2C2C2C;margin-bottom:6px;">Off White</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:16px;font-weight:300;color:#5C5956;">#FAF7F2</div>
    </div>
    <div>
      <div style="background:#2C2C2C;border-radius:12px;height:280px;margin-bottom:20px;"></div>
      <div style="font-family:'Crimson Pro',serif;font-size:20px;letter-spacing:0.2em;color:#2C2C2C;margin-bottom:6px;">Charcoal</div>
      <div style="font-family:'Noto Sans JP',sans-serif;font-size:16px;font-weight:300;color:#5C5956;">#2C2C2C</div>
    </div>
  </div>
</div>
`;
...
">
  ...
  <div style="
    position:absolute;
    width:900px; height:900px; border-radius:50%;
    background:radial-gradient(circle, rgba(201,168,76,0.18) 0%, transparent 62%);
  ...
  <div style="
    ...
    color:#2C2C2C; letter-spacing:0.1em;
    position:relative; z-index:2;
  ">金の時</div>
  <div style="
    font-family:'Crimson Pro',serif;
    font-size:28px; letter-spacing:0.6em;
    color:#C9A84C;
    margin-top:24px;
    position:relative; z-index:2;
  ">Golden Moments</div>
