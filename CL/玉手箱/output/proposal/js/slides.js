      ...
      <div class="s-main" style="gap:3cqw;">
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:2.5cqw;">
          ...
          <div style="padding:1cqw 3cqw 1cqw 0; display:flex; flex-direction:column; justify-content:center;">
            ...
            <div class="t-h1" style="color:var(--c-black); margin-bottom:1.8cqw; letter-spacing:0.1em;">逸品を、<br>伝統で。</div>
...
function slide08LogoVariation() {
  return `<section class="slide" style="background:#fff;" data-section="logo-variation" data-notes="ロゴのバリエーションです。">
    ...
    <div style="width:100%; height:100%; display:flex; align-items:center; justify-content:center; padding:8.5cqw 5cqw 3.5cqw;">
      <img src="../../brief/logo/03oju_logo_アートボード 1.svg" style="width:80%; height:auto; display:block;" alt="玉手箱ロゴ バリエーション">
    </div>
    <div class="s-copy" style="color:#aaa;">©CRATER Inc. 2026</div>
  </section>`;
}
...
function slide10KV() {
  return `<section class="slide" data-section="kv" data-notes="ビジュアルの方向性です。">
    ...
    <div style="position:relative; width:100%; height:100%; overflow:hidden;">
      <img src="../../brief/kv2.jpg" style="width:100%; height:100%; object-fit:cover; object-position:center 20%;" alt="Key Visual">
...
function slide11End() {
  return `<section class="slide" style="background:#fff;" data-section="end" data-notes="以上です。">
    <div style="width:100%; height:100%; display:flex; align-items:center; justify-content:center; padding:10cqw 8cqw;">
      <img src="../../brief/logo/03oju_logo-04.svg" style="width:60%; height:auto;" alt="玉手箱">
    </div>
  </section>`;
}
